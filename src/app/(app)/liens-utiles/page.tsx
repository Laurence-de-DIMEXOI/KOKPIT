    ...
    <div className="space-y-6">
      ...
      <div className="flex items-center justify-between">
        <div className="flex items-center gap-3">
          <div className="w-10 h-10 rounded-xl bg-[#838F58]/15 flex items-center justify-center">
            <Link2 className="w-5 h-5 text-[#838F58]" />
          </div>
          <div>
      ...
      {Object.keys(grouped).length === 0 ? (
        <div className="bg-cockpit-card rounded-card border border-cockpit p-12 text-center">
          ...
          <button
            onClick={openCreateModal}
            className="mt-4 text-[#838F58] font-medium text-sm hover:underline"
          >
                  ...
                  <div className="flex items-start gap-3">
                    ...
                    <div className="flex items-center gap-1 opacity-0 group-hover:opacity-100 transition-opacity">
                      <a
                        ...
                        className="p-1.5 rounded-md hover:bg-cockpit-dark/80 text-cockpit-secondary hover:text-[#9BA775] transition-colors"
                        title="Ouvrir"
                      >
            ...
            <div className="p-5 space-y-4 overflow-y-auto flex-1 min-h-0">
              ...
              <div>
                ...
                <input
                  ...
                  className="w-full px-3 py-2.5 rounded-lg border border-cockpit bg-cockpit-card text-cockpit-heading text-sm focus:outline-none focus:ring-2 focus:ring-[#838F58]/30 focus:border-[#838F58]"
                />
              </div>
