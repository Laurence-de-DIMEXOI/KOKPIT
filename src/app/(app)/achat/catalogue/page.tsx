      ...
      <div className="bg-white rounded-xl border border-gray-100 shadow-sm overflow-hidden">
        {loading ? (
          <div className="p-12 text-center">
            ...
            <p className="text-sm text-cockpit-secondary">Calcul de la classification ABC...</p>
            <p className="text-[10px] text-cockpit-secondary mt-1">Analyse des commandes des 12 derniers mois</p>
          </div>
        ) : (
