        ...
        <form onSubmit={handleSubmit} className="p-6 space-y-4">
          <div className="grid grid-cols-2 gap-4">
            <div>
              ...
              <input
                ...
                className="w-full bg-cockpit-dark border border-cockpit rounded-lg px-3 py-2 text-cockpit-primary text-sm focus:outline-none focus:border-[#D15F12] transition-colors"
              />
            </div>
            <div>
              <label className="block text-sm text-cockpit-secondary mb-1">
          ...
          <div>
            ...
            <textarea
              ...
              className="w-full bg-cockpit-dark border border-cockpit rounded-lg px-3 py-2 text-cockpit-primary text-sm focus:outline-none focus:border-[#D15F12] transition-colors resize-none"
            />
          </div>
  ...
  if (status === "loading") {
    return (
      <div className="flex items-center justify-center min-h-[60vh]">
        <Loader2 className="w-8 h-8 animate-spin text-[#D15F12]" />
      </div>
    );
  }
                        ...
                        >
                          ...
                          <td className="px-4 py-3 text-right">
                            <button
                              ...
                              className="p-1.5 rounded-lg hover:bg-white/10 text-cockpit-secondary hover:text-[#D15F12] transition-colors"
                              title="Corriger"
                            >
