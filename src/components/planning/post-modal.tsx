            ...
            <div className="flex-1 px-4 sm:px-6 py-4 sm:py-5 space-y-4 sm:space-y-5 lg:overflow-y-auto lg:min-h-0">
              ...
              <div className="lg:hidden">
                ...
                {coverImage ? (
                  ...
                  <button
                    ...
                    onClick={() => fileInputRef.current?.click()}
                    disabled={uploading}
                    className="w-full border-2 border-dashed border-gray-300 rounded-lg py-8 flex flex-col items-center gap-2 text-gray-400 hover:border-[#E36887] hover:text-[#E36887] transition-colors cursor-pointer disabled:opacity-50"
                  >
                    {uploading ? (
                      <>
              ...
              <div>
                ...
                <input
                  ...
                  className="w-full border border-gray-200 rounded-lg px-3 py-2 text-sm focus:outline-none focus:ring-2 focus:ring-[#E36887]/50 focus:border-[#E36887]"
                  autoFocus
                />
              </div>
              ...
              <div className="grid grid-cols-1 sm:grid-cols-3 gap-3 sm:gap-4">
                <div>
                  ...
                  <select
                    ...
                    className="w-full border border-gray-200 rounded-lg px-3 py-2 text-sm focus:outline-none focus:ring-2 focus:ring-[#E36887]/50 focus:border-[#E36887] bg-white"
                  >
                    {COLUMNS.map((col) => (
              ...
              <div>
                ...
                <textarea
                  ...
                  className="w-full border border-gray-200 rounded-lg px-3 py-2 text-sm focus:outline-none focus:ring-2 focus:ring-[#E36887]/50 focus:border-[#E36887] resize-y"
                />
              </div>
            ...
            <div className="hidden lg:flex lg:flex-col lg:w-[45%] lg:border-l lg:border-gray-100 p-5">
              ...
              {coverImage ? (
                ...
                <button
                  ...
                  onClick={() => fileInputRef.current?.click()}
                  disabled={uploading}
                  className="flex-1 border-2 border-dashed border-gray-300 rounded-lg flex flex-col items-center justify-center gap-2 text-gray-400 hover:border-[#E36887] hover:text-[#E36887] transition-colors cursor-pointer disabled:opacity-50 min-h-[200px]"
                >
                  {uploading ? (
                    <>
                      <Loader2 className="w-8 h-8 animate-spin" />
