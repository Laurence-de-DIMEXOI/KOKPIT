    ...
    >
      ...
      {action && (
        <button
          ...
          className="inline-flex items-center gap-2 bg-cockpit-yellow text-white px-5 py-2.5 rounded-lg text-sm font-semibold hover:bg-cockpit-yellow/90 transition-colors"
        >
          {action.label}
        </button>
      )}
